...
<head>
    ...
    <title>
        Crud operations in Laravel with Ajax
    </title>
...
<body>
    <div class="container">
        ...
        <div class="rightButton">
            <button type="button" name="create_record" id="create_record" class="btn btn-primary btn-sm">
                Create Record
            </button>
        </div>
        <br />
            ...
            <div class="modal-body">
                ...
                <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4">Frist Name : </label>
                        <div class="col-md-8">
                            <input type="text" name="frist_name" id="frist_name" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4">Select Category Image : </label>
                        <div class="col-md-8">
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (html) {
                    $('#frist_name').val(html.data.frist_name);
